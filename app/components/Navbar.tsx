    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 border-[#272727] border-l border-r flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-2">
          <button className="border border-gray-500 px-4 py-1.5 rounded-full text-sm">
            Login
          </button>
  ...
  >
    ...
    <span className="text-white text-xl">→</span>
          ...
          <div className="flex flex-col gap-3 pt-10">
            <Link
              href="#"
              className="border border-gray-500 px-4 py-2 rounded-full text-sm text-center"
            >
              Login
            </Link>
            <Link
              href="#"
              className="bg-white text-black px-4 py-2 rounded-full text-sm font-medium text-center"
            >
              Sign up
            </Link>
          </div>
