  ...
  return (
    <div className="bg-black text-white min-h-screen ">
      <div className="border-[#272727] border-l border-r max-w-7xl mx-auto">
        <section className="max-w-[68rem] border-[#272727] border-l border-r  mx-auto  pt-20 text-center">
          <div className="text-[49px] font-semibold leading-tight ">
            The Only AI That <span className="text-lime-400">Predicts</span>{" "}
            Pumps
          </div>
          <div className="text-[49px] md:text-5xl font-semibold leading-tight ">
            AND <span className="text-lime-400">Detects</span> Rug Pulls
          </div>
          <p className="text-gray-400 text-lg mt-3 mb-8">
            spots explosive Memecoins opportunities before the crowd <br />
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm  mb-6">
            ...
            <div className="flex gap-2 items-center">
              <svg
                ...
                fill="none"
              >
                <g clipPath="url(#clip0_34414_35270)">
                  <path
                ...
                <defs>
                  <clipPath id="clip0_34414_35270">
                    <rect width="24" height="24" fill="white" />
                  </clipPath>
                </defs>
              </svg>
              From chart noise to winning trades
            </div>
            <div className="flex gap-2 items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
