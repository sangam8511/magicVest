...
function Footer() {
  ...
  <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between gap-12">
    ...
    <div className="flex flex-col gap-6">
      ...
      <p className="text-sm text-gray-600 max-w-sm">MagicVest aims for a user-friendly interface, ensuring 
      ease of navigation and feature comprehension.</p>
      <p className="text-sm text-gray-600">contact@Magicvest.ai</p>

      {/* Social Icons */}
      <div className="flex gap-3">
        <a href="#"><img src="/x.svg" alt="X" className="w-7 h-7" /></a>
        <a href="#"><img src="/linkedin.svg" alt="LinkedIn" className="w-7 h-7" /></a>
        <a href="#"><img src="/instagram.svg" alt="Instagram" className="w-7 h-7" /></a>
        <a href="#"><img src="/youtube.svg" alt="YouTube" className="w-7 h-7" /></a>
      </div>
    </div>
